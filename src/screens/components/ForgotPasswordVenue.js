...
export default class ForgotPasswordVenue extends React.Component {
  ...
  constructor(props) {
    ...
    this.venueForgotPassword = this.venueForgotPassword.bind(this);
  }
  ...
  venueForgotPassword() {
   ...
   if (this.state.email == "" || this.state.email == null || this.state.email == undefined)
    ...
    fetch(appConstant.BASE_URL + appConstant.VENUEFORGOTPASSWORD, {
      method: 'POST',
      headers: {
          ...
          setTimeout(() => {
            if (responseJson.success_code == 0) {
              this.props.navigation.navigate('SignVenue',
                {
                  "forgotPasswordvenue": responseJson,
    ...
    headerLeft: (
      <TouchableOpacity style={{ marginLeft: 10 }}>
        <Icon name='angle-left'
          ...
          size={35}
          color='#727272'
          onPress={() => navigation.navigate('SignVenue')}
        />
      </TouchableOpacity>
    ),
    headerTintColor: '#fff',
  ...
  render() {
    return (
      <View style={styles.container}>
        <Image style={{ height: 60, width: 60, justifyContent: 'center', alignSelf: 'center' }} source={require('../../Assets/img/lock_venue.png')} />
        ...
        <View style={{ padding: 30, marginTop: 3 }}>
          ...
          <TouchableOpacity style={styles.TouchableSign_in} onPress={this.venueForgotPassword.bind(this)} >
...
AppRegistry.registerComponent('uGigs', () => ForgotPasswordVenue);
